...
public class AdminMenuItem extends JPanel {
    ...
    public AdminMenuItem(ModelMenuItem item, int index, MigLayout layout) {
        this.index = index;
    ...
    private void init(ModelMenuItem item) {
        ...
        AdminItem menu = new AdminItem(true, 0);
        ...
        for (String subMenu : item.getSubMenu()) {
            AdminItem sMenu = new AdminItem(false, ++subIndex);
    ...
    private void initAnimator(MigLayout layout) {
        animator = new Animator(300, new TimingTargetAdapter() {
            ...
            public void timingEvent(float fraction) {
                ...
                layout.setComponentConstraints(AdminMenuItem.this, "h " + s + "!");
